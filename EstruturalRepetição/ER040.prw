...
user function ER040()
    ...
    nMediaVeiculos := nTotalVeiculos / 2

    nMediaAcidentes := nTotalAcidentes / 2
    ...
    FwAlertInfo("Média de acidentes nas cidades com menos de 2.000 veículos de passeio: " + AllTrim(Str(nMediaAcidentes)))
